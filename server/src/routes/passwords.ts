...
export default (router: Router) => {
  router.get("/api/passwords", getPasswords);
  router.post("/api/passwords", createPassword);
  router.patch("/api/passwords/:id", updatePassword);
  router.delete("/api/passwords/:id", deletePassword);
};
